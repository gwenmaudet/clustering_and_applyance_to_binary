...
class sensor:
    def __init__(self,p1, p2, period=conf.initial_sensor_period, name="sensor",
                 battery=conf.C, fst_wake_up=0, event=[], shut_down=10000000000000000000000000000, battery_type=0,precision = 0.3):
