...
def compute_diversity_thanks_to_sample_step(emission_time_per_sensor, simul_time, T=conf.T, sample_step=conf.sample_step):
    utilities_before = []
    utilities = []
    emission_instant = conf.beggining_time
    ...
    while emission_instant < simul_time:
        ...
        if emission_instant<conf.begginning_observing:
            utilities_before.append(utility)
        else:
            utilities.append(utility)
        emission_instant += sample_step
    return utilities, utilities_before
