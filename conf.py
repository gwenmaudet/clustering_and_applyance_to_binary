...
lambda_activation_T1 = 1
#lambda_activation_T2 = 0.5
lambda_activation_T2 = 1
#T_inclusion = 10
...
step_for_computation_of_aera = 0.0111
...
max_observation_window_for_merging = None

max_observation_window_for_splitting = None

nb_min_of_messages_merging = 1
nb_min_of_messages_splitting = 1

nb_max_total_for_messages_merging = 200
nb_max_total_for_messages_splitting = 50
...
T1_initial_temp = -10
T2_initial_temp = 10
if os. path. isdir("C:\\Users\\Gwen Maudet\\PycharmProjects\\clustering and applyance to binary\\json_files\\T1_changing_points.json"):
    with open(
    ...
    def T1(t):
        ...
        json_index_t = min(int(t / step) - 5, len(json_t) - 1)
